...
window.addEventListener('message', function(event) {
	switch (event.data.action) {
			...
			if (selectedWindow == "none") {
				...
				$('#menu').html(`
					<div class="d-flex justify-content-center flex-column align-items-center">
						...
						<br>
						<div style="font-size: 20px; color: #fff;">Ładowanie konta...</div>
					</div>
				`);
				$("#menu").fadeIn();
				$(".main_card").fadeIn();
		...
		case 'bankmenu':
			if (selectedWindow == "loading_data") {
				...
				setTimeout(function(){
					...
					var bankMoney = event.data.playerBankMoney.toLocaleString()
					$('#menu').html(`
						<div class="col-md-2 d-flex flex-column" style="border-right: 1px solid rgba(62, 63, 75); width: 177px;">
							<img src="logo.png" class="logo">
							<hr>
							<span class="sidebar-title">Konto osobiste</span>
							<div id="sidebar"></div>
						...
						<div class="col-md-10" style="width: 82%; display: flex; flex-direction: column;">
							<div class="d-flex justify-content-between align-items-center">
								<span class="selected-page" style="margin-left: 15px;"><span id="page-title">Przegląd</span></span>
								<div>
									<span class="username align-middle">
										<span id="playerName"></span> <span id="avatar">${avatar}</span>
									</span>
									<div style="font-size: 14px; margin-top: -9px; font-weight: 500; position: absolute; right: 7.2%;">
										<span>Portfel: $<span id="wallet_money"></span></span>
									</div>
									<div style="font-size: 14px; margin-top: -12px; font-weight: 500; position: absolute; right: 21.2%;">
										<span>W Banku: <span id="bank_money">${bankMoney}</span>$</span>
									</div>
								</div>
							</div>
							<hr>
			...
			break
		case 'updatevalue':
			$("#bank_money").html(event.data.playerBankMoney.toLocaleString());
		...
		case 'transactions_page':
			...
			$('#page-title').html('Płatności');

			$('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Przegląd</span></p>
				<p class="sidebar-item selected" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Płatności</span></p>
			...
			for(var i = 0; i < num; i++) {
				...
				if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								...
								<div style="margin-top: -5px;">Otrzymane</div>
							</td>`;
				...
				// Sent
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								...
								<div style="margin-top: -5px;">Wysłane</div>
							</td>`;
				...
				// Wpłacone
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								...
								<div style="margin-top: -5px;">Wpłacone</div>
							</td>`;
					amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #2ecc71; float: right;">+ $${db.value.toLocaleString()}</span> </td>`;
				// Wypłacone
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								From <span style="color: #1f5eff; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Wypłacone</div>
							</td>`;
					amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - $${db.value.toLocaleString()}</span> </td>`;
				}
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; qBanking;">TRANSAKCJE</h6>
						    <p class="card-text" id="totalInvoices" style="qBanking;">${numOfTransactions}</p>
						  </div>
						</div>
					</div>
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; qBanking;">WPŁATY</h6>
						    <p class="card-text" id="totalIncome" style="qBanking;">$${event.data.graph_values[7].toLocaleString()}</p>
						  </div>
						</div>
					</div>
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; qBanking;">WYPŁATY</h6>
						    <p class="card-text" id="unpaidInvoices" style="qBanking;">$${event.data.graph_values[8].toLocaleString()}</p>
						  </div>
						</div>
					</div>
					<div class="col col-md-3">
						<div class="card" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; qBanking;">BILANS</h6>
						    <p class="card-text" id="awaitedIncome" style="qBanking;">$${event.data.graph_values[9].toLocaleString()}</p>
						  </div>
						</div>
					</div>
				</div>
				<table id="transactionsTable">
					<tbody id="transactionsData">
						<tr>
							...
							<td class="align-middle" style="font-weight: 500;">- 732 500 DOL</td>
						</tr>
						<tr>
							...
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500; color: #2ecc71;">+ 57 000 DOL</td>
						</tr>
					</tbody>
				</table>
			`);
		...
		case 'society_transactions':
			...
			$('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Przegląd</span></p>
				<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Płatności</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Ustawienia</span></p>
			`);
...
$(document).on('click', "#overview_page", function() {
	$.post('https://qBanking/action', JSON.stringify({
...
function overview_page_function(event) {
	...
	$('#page-title').html('Przegląd');

	$('#sidebar').html(`
		<p class="sidebar-item mt-2 selected" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Przegląd</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Płatności</span></p>
		<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Ustawienia</span></p>
	`);
				...
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #292a31; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Ostatnie transakcje</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions"><i class="fas fa-eye"></i> VIEW ALL</span></span>
						</div>
							...
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									<tr>
										...
										<td class="align-middle" style="font-weight: 500;"><span> - 732 500 DOL</span> </td>
									</tr>
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
										...
										<td class="align-middle" style="font-weight: 500;"><span style="color: #2ecc71;">+ 12 750 DOL</span> </td>
									</tr>
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
										...
										<td class="align-middle" style="font-weight: 500;"><span>- 7 000 DOL</span> </td>
									</tr>
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
										...
										<td class="align-middle" style="font-weight: 500;"><span style="color: #2ecc71;">+ 57 000 DOL</span> </td>
									</tr>
								</tbody>
							</table>
						</div>
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%;"><span style="color: #fff; font-size: 12px; margin-left: 40px; font-weight: 500;">Banking</span></span><span><i class="fas fa-wifi"></i></span></span>
						...
						<hr>
						<p class="card-text text-center" style="qBanking;"><span style="color: #fff;">Konto:</span> $<span id="playerBankMoney"></span></p>
						<p class="card-text text-center" style="qBanking;"><span style="color: #fff;">IBAN:</span> <span id="playerIBAN">BRAK</span></p>
					</div>
				</div>
				<!--<br>
				<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						...
						<p class="card-text"><span style="color: #fff;">IBAN:</span> BRAK</p>
					</div>
				</div>-->
				<div class="card text-center h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
						<div class="d-flex justify-content-center">
							<button type="button" id="depositMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#depositModal"><i class="bi bi-upload"></i> Wpłata</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="withdrawMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#withdrawModal"><i class="bi bi-download"></i> Wypłata</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="transferMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#transferModal"><i class="fas fa-exchange-alt"></i> Przelew</button>
						</div>
					</div>
				</div>
			</div>
	...
	$("#playerName").html(event.data.firstname + " " + event.data.lastname);
						...
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #292a31; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
								    <span style="font-size: 19px; color: #fff;">Zmień IBAN</span>
									...
									<button type="button" id="change_iban" class="btn btn-blue" style="border-radius: 10px; flex-basis: 100%; margin-top: 12px; width: 100%;" disabled><i class="fas fa-paper-plane"></i> Zmień</button>
								  </div>
								</div>
							</div>
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center" style="font-size: 15px;">
								    <span>Zmiana numeru IBAN kosztuje $${event.data.ibanCost}</span>
								    <hr style="color: #fff;">
								    <span>Numer IBAN zawsze zaczyna się od "${event.data.ibanPrefix}" nie wpisuj samemu początku "${event.data.ibanPrefix}"</span>
								    <hr style="color: #fff;">
									<span>Maksymalna długość numeru to ${event.data.ibanCharNum}</span>
								  </div>
								</div>
							</div>
						</div>
					...
					<div class="">
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #292a31; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
								    <span style="font-size: 19px; color: #fff;">Zmień PIN</span>
									...
									<button type="button" id="change_pin" class="btn btn-blue" style="border-radius: 10px; flex-basis: 100%; margin-top: 12px; width: 100%;" disabled><i class="fas fa-paper-plane"></i> Zmień</button>
								  </div>
								</div>
							</div>
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #1f5eff; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center" style="font-size: 15px;">
								    <span>Zmienienie kodu PIN kosztuje $${event.data.pinCost}</span>
								    <hr style="color: #fff;">
									<span>Maksymalna długość PINu to ${event.data.pinCharNum}</span>
									<hr style="color: #fff;">
									<span>Musisz używać tylko cyfr</span>
								  </div>
								</div>
							</div>
						</div>
	...
	setTimeout(function () {
		$('#menu').html(`
			<div class="d-flex justify-content-center flex-column align-items-center">
				<span class="load"></span>
				<br>
				<div style="font-size: 20px; color: #fff;">Wylogowywanie...</div>
			</div>
		`);
		$("#menu").fadeIn();
