...
AddEventHandler('flux_scratchcard:payment', function()
	...
	if ScratchTable[xPlayer.identifier] ~= nil then
		if ScratchTable[xPlayer.identifier] > 0 then
			...
			exports['ocean_logs']:SendLog(source, "ZDRAPKA: " .. ' WYGRANO ' .. ScratchTable[xPlayer.identifier] .. '$', 'casino', '3066993')
		...
		TriggerEvent('exile:banPlr', "nigger", _source, "Tried to cheat (oceanocan_scratch)")
		exports['ocean_logs']:SendLog(_source, GetCurrentResourceName() .. ":payment - Wykryto próbę oszustwa", 'anticheat')
	end
end)
...
ScratchCard = function(source, type)
	...
	if ScratchTable[xPlayer.identifier] == 0 then
		...
		TriggerEvent('exile:banPlr', "nigger", _source, "Tried to cheat (ocan_scratch)")
		exports['ocean_logs']:SendLog(_source, GetCurrentResourceName() .. ":scratchCard - Wykryto próbę oszustwa", 'anticheat')
	end
end
