...
function MenuInsurance(station)
	if station == 'NNW' or station == 'OC' then
		...
		if (PlayerData.job.name == 'mechanik' and PlayerData.job.grade_name == 'boss') or (PlayerData.job.name == 'ambulance' and PlayerData.job.grade_name == 'boss') or (PlayerData.job.name == 'gheneraugarage' and PlayerData.job.grade_name == 'boss') then
...
local limitworkers = exports['ocean_legaljobs']:GetLimits(hinhi)]]
