...
Strings = {
    ['press_start'] = 'Naciśnij ~INPUT_PICKUP~ aby wziąć kule',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ Wybierz\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Zatwierdź\n~INPUT_FRONTEND_RRIGHT~ Anuluj',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Rotacja\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Siła\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Kamera\n~INPUT_ATTACK~ Rzuć\n~INPUT_FRONTEND_RRIGHT~ Zakończ gre',
    ['force'] = 'Siła: %s',
    ['strike'] = {'GRATULACJE, MASZ CO ŚWIĘTOWAĆ", "TO STRIKE!!!'},
    ['spare'] = {'Kręgle', 'Dobra gra! Masz zapas'},
    ['x_pinsdown'] = {'Kręgle', 'Uzyskałeś %s z %s pinów'},
    ['this_occupied'] = 'Ten tor do gry w kręgle jest zajęty.',
    ['every_occupied'] = 'Wszystkie tory do gry w kręgle są zajęte.',
    ['blip'] = 'Kręgielnia'
}