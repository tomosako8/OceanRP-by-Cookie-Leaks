...
CreateThread(function()
	...
	while true do
		if PlayerData.secondjob.name == 'burgershot' then
...
RegisterNetEvent('esx:secondjob')
AddEventHandler('esx:secondjob', function(secondjob)
...
refreshBlips = function()
	if PlayerData.secondjob ~= nil and PlayerData.secondjob.name == 'burgershot' then
		for i=1, #Blips, 1 do
			if Blips[i].see then
	...
	while true do
		...
		if PlayerData.secondjob ~= nil and PlayerData.secondjob.name == 'burgershot' then
			...
			for k,v in pairs(Cfg) do
				for i=1, #v, 1 do
					if CanWork or (k == 'Cloakroom' or k == 'BossActions' and PlayerData.secondjob.grade >= 7 or k == 'SellCoffee' and PlayerData.secondjob.grade >= 7) then
...
CreateThread(function()
	while true do
		...
		Citizen.Wait(10)
		if PlayerData.secondjob and PlayerData.secondjob.name == 'burgershot' then
	...
	if kochacpieski == true then
		if count >= 100 then
			...
			ESX.Streaming.RequestAnimDict(lib, function()
				...
				ESX.ShowNotification('~y~Trwa składanie burgerów...')
				...
				if kursy then
					...
					for i=1, #kursy, 1 do
						...
						elseif kursy[i].secondjob_grade == 2 then
							grade = 'Pracownik'
						elseif kursy[i].secondsecondjob_grade == 3 then
							grade = 'Fachowiec'
