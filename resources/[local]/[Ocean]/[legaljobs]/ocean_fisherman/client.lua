...
CreateThread(function()
	...
	while true do
		if PlayerData.secondjob.name == 'fisherman' then
...
CreateThread(function()
	...
	while true do
		Citizen.Wait(3)
		if PlayerData.secondjob ~= nil and PlayerData.secondjob.name == 'fisherman' then
			local found = false
			...
			for k,v in pairs(Cfg) do
				for i=1, #v, 1 do
					if CanWork or k == 'Center' or (k == 'BossActions' and PlayerData.secondjob.grade >= 4) then
...
CreateThread(function()
	while true do
		...
		if PlayerData.secondjob ~= nil and PlayerData.secondjob.name == 'fisherman' then
			...
			if IsControlJustReleased(0, 167) and IsInputDisabled(0) and PlayerData.secondjob.grade >= 6 then
...
OpenBossMenu = function()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fisherman_boss', {
		...
		if data.current.value == '1' then
			...
			elseif PlayerData.secondjob.grade >= 7 then
				TriggerEvent('esx_society:openBossMenu', 'fisherman', function(data, menu)
					menu.close()
