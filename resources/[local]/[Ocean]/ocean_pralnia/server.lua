...
AddEventHandler('exile_pralnia:request', function()
	if not recived_token[source] then
        ...
        TriggerEvent('exilerp:banPlr', "nigger", source, "Tried to get token (ocean_pralnia)")
		exports['ocean_logs']:SendLog(source, "PRALNIA: Próba otrzymania ponownie tokenu!", 'anticheat', '15844367')
	end
end)
...
AddEventHandler(event, function(resourceName)
    if resourceName == GetCurrentResourceName() then
        ...
        if brudna >= Config.MinBrud then
            ...
            exports['ocean_logs']:SendLog(source, "PRALNIA: Chłop przeprał siano i dostał: " ..random, 'pralnia', '15844367')
