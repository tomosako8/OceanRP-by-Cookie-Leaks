...
function GetPrice(price)
	if PlayerData.job and (PlayerData.job.name == 'gheneraugarage' or PlayerData.job.name == 'offgheneraugarage' or PlayerData.job.name == 'mechanik' or PlayerData.job.name == 'offmechanik' or PlayerData.job.name == 'mechanik3' or PlayerData.job.name == 'offmechanik3' or PlayerData.job.name == 'mechanik4' or PlayerData.job.name == 'offmechanik4') then
		...
		if Config.prices.mods[mod].percent or Config.prices.mods[mod].price then
			...
			for i = 0, mods do
				...
				if lbl ~= nil then
					...
					if mname == "NULL" then
						local btn = m:addPurchase("Cookie #" .. (i + 1), price)
						btn.modtype = mod
						btn.mod = i
					else
