...
RegisterCommand('skinsave', function(source, args, user)
	if source == 0 then
		...
		local xPlayer = ESX.GetPlayerFromId(source)
		if (xPlayer.group == 'best' or xPlayer.group == 'starszyadmin' or xPlayer.group == 'starszymod' or xPlayer.group == 'superadmin' or xPlayer.group == 'admin' or xPlayer.group == 'mod' or xPlayer.group == 'support') then
...
RegisterCommand('skin', function(source, id, user)
	if source == 0 then	
		...
		local xPlayer = ESX.GetPlayerFromId(source)
		if (xPlayer.group == 'best' or xPlayer.group == "starszyadmin" or xPlayer.group == 'starszymod' or xPlayer.group == 'starszymod' or xPlayer.group == 'superadmin' or xPlayer.group == 'admin' or xPlayer.group == 'mod' or xPlayer.group == 'support') then
			if id[1] ~= nil then
