...
ESX.RegisterUsableItem('burbon', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.removeInventoryItem('burbon', 1)

	TriggerClientEvent('esx_status:add', source, 'drunk', 100000)
	TriggerClientEvent('esx_basicneeds:onDrink', source)
end)

ESX.RegisterUsableItem('cydr', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.removeInventoryItem('cydr', 1)

	TriggerClientEvent('esx_status:add', source, 'drunk', 45000)
	TriggerClientEvent('esx_basicneeds:onDrink', source)
end)

ESX.RegisterUsableItem('koniak', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.removeInventoryItem('koniak', 1)
			...
			if args[1] then
				...
				if target ~= nil then
					...
					if GetPlayerName(target) then
						...
						exports['ocean_logs']:SendLog(source, "Użyto komendy /heal na: " .. target, "admin_commands")
					else
				...
				exports['ocean_logs']:SendLog(source, "Użyto komendy /heal ", "admin_commands")
