...
Config.Weapons = {
	...
	{name = 'WEAPON_DBSHOTGUN', take_ammo = 'extendedclip', label = _U('weapon_dbshotgun'), item = 'dbshotgun', tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_shells'), hash = GetHashKey('AMMO_SHOTGUN')}},
	{name = 'WEAPON_AUTOSHOTGUN', take_ammo = 'extendedclip', label = _U('weapon_autoshotgun'), item = 'autoshotgun', tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_shells'), hash = GetHashKey('AMMO_SHOTGUN')}},
	{name = 'WEAPON_MUSKET', take_ammo = 'extendedclip', label = _U('weapon_musket'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_SNIPER')}, item = 'musket'},
	...
	{name = 'WEAPON_MINIGUN', item = "minigun", take_ammo = 'extendedclip', label = _U('weapon_minigun'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_MINIGUN')}},
